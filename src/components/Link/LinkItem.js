...
import distanceInWordsToNow from 'date-fns/esm/formatDistanceToNow/index.js'
...
function LinkItem({ link, index, showCount, history }) {
  ...
  function handleDeleteLink(params) {
  ...
  return (
    <div className="flex item-start mt">
